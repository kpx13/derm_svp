...
DATABASES = {
    'default': {
        ...
        'NAME': 'derm_svp',   # Or path to database file if using sqlite3.
        'USER': 'derm_svp',                      # Not used with sqlite3.
        'PASSWORD': 'derm_svp',                  # Not used with sqlite3.
...
ROOT_URLCONF = 'derm_svp.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'derm_svp.wsgi.application'
